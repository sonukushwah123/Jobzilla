                              ...
                              <div className="modal-content">
                                <form>
                                  ...
                                  <div className="modal-body">
                                    <p>
                                      It is the first thing recruiters notice in
                                      your profile. Write concisely what makes
                                      you unique and right person for the job
                                      you are looking for.
                                    </p>
                    ...
                    <div className="  d-flex align-items-center justify-content-center">
                      <div className="w-50">
                        ...
                        <p className="text-center">
                          your resume is already created if you want to edit
                          your resume you can click the link below
                          <br />
                          <Link
